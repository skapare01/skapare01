...
public class VerifyFloorPlanLevelSpecialsSetupIT extends BaseBrowserTest {
    public VerifyFloorPlanLevelSpecialsSetupIT() {
        super("avantic");
    }

    @Test //Test Case #2228350 (stop at floor plan tab)
    public void shouldVerifyFloorPlanLevelSpecialsSetup_whenTabsAreClicked() {
        ...
        assertTrue("failed to click floor plan specials tab", testSpecials.clickFloorPlanSpecialsTab());
    }
}
